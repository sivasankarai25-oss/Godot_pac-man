...
func _update_display() -> void:
	score_label.text = str(score).pad_left(6, '0')
	high_score_label.text = "HIGH " + str(high_score).pad_left(6, '0')
	lives_label.text = "LIVES: " + str(lives).pad_left(2, '0')
	level_label.text = "LEVEL: " + str(level).pad_left(2, '0')
